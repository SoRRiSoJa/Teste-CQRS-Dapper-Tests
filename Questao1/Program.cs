    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (resp == 's' || resp == 'S')
            {
                ...
                decimal depositoInicial = new(double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture));
            ...
            decimal quantia = new(double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture));
            ...
            quantia = new(double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture));
            conta.Saque(quantia);
            Console.WriteLine("Dados da conta atualizados:");
            Console.WriteLine(conta);
